...
curve(d_A, from=0, to=180, xlab = "quantity", ylab = "price")
...
curve(d_B, from=0, to=200, xlab= "quantity", ylab = "price", add= TRUE)
...
curve(d_C, from=0, to=220, xlab= "quantity", ylab = "price", add= TRUE)
...
curve(d_D, from=0, to=300, xlab= "quantity", ylab = "price", add= TRUE)
